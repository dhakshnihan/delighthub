...
<!-- Mirrored from themekita.com/demo-atlantis-bootstrap/livepreview/examples/demo2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Nov 2022 13:09:13 GMT -->
<head>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="dark2">
				...
				<a href="index.php" class="logo">
					<img src="./assets/img/example23.jpg" alt="navbar brand"  height="36" class="navbar-brand1">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="masters">
								<ul class="nav nav-collapse">
									<li>
										<a href="masters/brand_master_model.html">
											<span class="sub-item">Product Brand</span>
										</a>
									</li>
									<li>
										<a href="masters/category_master_model.html">
											<span class="sub-item">Product Category</span>
										</a>
									</li>
									<li>
										<a href="masters/sub_category_master_model.php">
											<span class="sub-item">Product Sub Category</span>
										</a>
									</li>
									<li>
										<a href="masters/prod_master_model.php">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="views">
								<ul class="nav nav-collapse">
									<li>
										<a href="masters/prod_master_view.php">
											<span class="sub-item">Products View</span>
										</a>
									</li>
									<li>
										<a href="masters/brand_master_view.php">
											<span class="sub-item">Product Brands</span>
										</a>
									</li>
									<li>
										<a href="masters/category_master_view.php">
											<span class="sub-item">Product Category</span>
										</a>
									</li>
									<li>
										<a href="masters/sub_category_master_view.php">
											<span class="sub-item">Product Sub Category</span>
										</a>
									</li>
								</ul>
...
<!-- Mirrored from themekita.com/demo-atlantis-bootstrap/livepreview/examples/demo2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Nov 2022 13:09:35 GMT -->
</html>