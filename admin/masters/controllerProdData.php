     ...
     if(isset($_POST['submit'])){
        ...
        $targetPath = $uploadPath . basename( $_FILES['uploadImg']['name']);
		  ...
		  if(move_uploaded_file($tempPath, $targetPath)) {
            $sql="insert into tbl_products(PRODN01,PRODN02,PRODN03,PRODN04,PRODN05,PRODN06,PRODN07,PRODN08,PRODN09,PRODN10,PRODN11,PRODN13) values
            ('".$_POST['prod_name']."','".$_POST['prod_code']."','".$_POST['region_id']."','".$_POST['sub_category_id']."','".$_POST['prod_des']."','".$_POST['prod_price']."','".$filename."','Active',now(),'".$_POST['category_id']."','".$_POST['prod_rating']."','".$_POST['prod_top_orders']."')";
            // echo $sql;
            mysqli_query($con,$sql);
            echo "<script>
