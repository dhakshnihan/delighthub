									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												<?php
													$sno=1;
													$sql="select *,tbl_orders.status as order_status from tbl_orders 
                                                    left join tbl_users on tbl_users.id=tbl_orders.fk_user_id";
													// echo $sql;
													...
													echo '<tr>
                                                            ...
                                                            <td>'.$row['order_recieved'].'</td>
                                                            <td>'.$row['order_processed'].'</td>
                                                            <td>'.$row['order_shipped'].'</td>
